    ...
    return (
        <DashboardLayout>
            <div className="space-y-6">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 capitalize">invoices</h1>
                    <p className="text-sm text-slate-500 mt-1">Manage your invoices</p>
                </div>
                ...
                <Card className="mt-8 border-dashed border-2 border-slate-200">
                    <CardContent className="flex flex-col items-center justify-center p-12 text-center">
                        ...
                        <p className="text-slate-500 mt-2 max-w-sm">
                            The invoices module is currently being developed and will be available in the upcoming release.
                        </p>
                    </CardContent>
                </Card>
            </div>
