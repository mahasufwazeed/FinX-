            ...
            <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-24 xl:px-32 relative h-screen overflow-y-auto">
                ...
                <div className="max-w-md w-full mx-auto md:mx-0">
                    ...
                    <div className="mt-6">
                        <button
                            type="button"
                            title="Google SSO requires backend OAuth integration"
                            className="flex w-full items-center justify-center gap-3 rounded-md border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition-colors"
                            onClick={() => setError("Google Single Sign-On requires backend OAuth configuration (Pending).")}
                        >
